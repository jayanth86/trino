        ...
        extends BaseConnectorSmokeTest
{
            ...
            throws Exception
    {
        ...
        return LakehouseQueryRunner.builder()
                ...
                .addLakehouseProperty("hive.metastore.glue.region", FLOCI_REGION)
                .addLakehouseProperty("hive.metastore.glue.endpoint-url", floci.endpoint().toString())
                .addLakehouseProperty("hive.metastore.glue.aws-access-key", FLOCI_ACCESS_KEY)
                .addLakehouseProperty("hive.metastore.glue.aws-secret-key", FLOCI_SECRET_KEY)
